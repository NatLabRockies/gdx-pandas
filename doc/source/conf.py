...
latex_documents = [
    (master_doc, 'gdx-pandas.tex', 'gdx-pandas Documentation',
     'Elaine T. Hale', 'manual'),
]
...
man_pages = [
    (master_doc, 'gdx-pandas', 'gdx-pandas Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gdx-pandas', 'gdx-pandas Documentation',
     author, 'gdx-pandas', 'One line description of project.',
     'Miscellaneous'),
]
